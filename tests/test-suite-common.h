...
#if (TS_HAS_CLANG_VER_(20, 0, 0))
# define TS_DISABLE_WUNSAFE_BUFFER_USAGE_IN_LIBC_CALL_                         \
     TS_DISABLE_WARNING_("-Wunsafe-buffer-usage-in-libc-call")
# define TS_REENABLE_WUNSAFE_BUFFER_USAGE_IN_LIBC_CALL_ TS_REENABLE_WARNING_
#else
# define TS_DISABLE_WUNSAFE_BUFFER_USAGE_IN_LIBC_CALL_
# define TS_REENABLE_WUNSAFE_BUFFER_USAGE_IN_LIBC_CALL_
#endif
