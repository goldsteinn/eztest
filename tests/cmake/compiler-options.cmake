...
option(EZTEST_STACK_ALLOC_LIMIT_
       "Set warning limit for stack size related checks (0 means none)" 0
)
option(EZTEST_HEAP_ALLOC_LIMIT_
       "Set warning limit for heap size related checks (0 means none)" 0
)

set(EZTEST_CLANG_18_0_0_WARNING_COMMON_FLAGS_ "-Weverything")

if(${EZTEST_STACK_ALLOC_LIMIT_} GREATER 0)
  list(APPEND EZTEST_CLANG_18_0_0_WARNING_COMMON_FLAGS_
       "-Wframe-larger-than=${EZTEST_STACK_ALLOC_LIMIT_}"
  )
endif()

set(EZTEST_CLANG_18_0_0_WARNING_C_FLAGS_
    ${EZTEST_CLANG_18_0_0_WARNING_COMMON_FLAGS_}
)
set(EZTEST_CLANG_18_0_0_WARNING_CXX_FLAGS_
    ${EZTEST_CLANG_18_0_0_WARNING_COMMON_FLAGS_}
)

set(EZTEST_GCC_14_0_0_WARNING_COMMON_FLAGS_
    "-WNSObject-attribute"
    "-Wabi=0"
    "-Waddress"
...
set(EZTEST_GCC_14_0_0_WARNING_C_FLAGS_
    "-Wabsolute-value"
    "-Wbad-function-cast"
    "-Wc++-compat"
    "-Wc11-c23-compat"
...
set(EZTEST_GCC_14_0_0_WARNING_CXX_FLAGS_
    "-Wabi-tag"
    "-Waligned-new=all"
    "-Wc++0x-compat"
    "-Wc++11-compat"
...
function(
  eztest_filter_supported_flags_
  EZTEST_INFRA_
  EZTEST_LANG_
  EZTEST_FLAGS_INOUT_
)
  ...
  while(${EZTEST_NFLAGS_} GREATER 0)
    while(ON)
      ...
      if(${EZTEST_SLICE_OKAY_})
        list(APPEND EZTEST_SUPPORTED_FLAGS_ ${EZTEST_FLAGS_SLICE_})
        break()
      endif()
...
string(
  REPLACE " "
          ";"
          EZTEST_WARNING_CXX_FLAGS_
          "${EZTEST_WARNING_CXX_FLAGS_}"
)
string(
  REPLACE " "
          ";"
          EZTEST_WARNING_C_FLAGS_
          "${EZTEST_WARNING_C_FLAGS_}"
)
