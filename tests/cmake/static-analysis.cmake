...
option(
  EZTEST_CLANG_TIDY
  "Path: path to clang tidy executable"
)
...
if(NOT EZTEST_CLANG_TIDY_EXE_)
  find_program(
    EZTEST_CLANG_TIDY_EXE_
    NAMES ${EZTEST_CLANG_TIDY_EXE_NAMES_}
    NO_CACHE
  )
endif()
...
#execute_process(
#  COMMAND
#  ${EZTEST_CLANG_TIDY_EXE_} --version
#  ERROR_VARIABLE
#  EZTEST_CLANG_TIDY_VERSION_ERR_
#  OUTPUT_VARIABLE
#  EZTEST_CLANG_TIDY_VERSION_OUT_
#)
#
#if(EZTEST_CLANG_TIDY_VERSION_ERR_)
#  unset(EZTEST_CLANG_TIDY_VERSION_OUT_)
#endif()
#
#if(EZTEST_CLANG_TIDY_VERSION_OUT_)
#  string(
#    REGEX MATCH
#    "version[ ]+[0-9]+\.[0-9]+\.[0-9]+"
#    EZTEST_CLANG_TIDY_VERSION_
#    ${EZTEST_CLANG_TIDY_VERSION_OUT_}
#  )
#  string(
#    REGEX MATCH
...
#endif()
#
#if(NOT EZTEST_CLANG_TIDY_VERSION_)
#  message(WARNING "Unable to determine clang-tidy version")
#else()
#  if(EZTEST_CLANG_TIDY_VERSION_ LESS 19)
#    message(WARNING "clang-tidy version ${EZTEST_CLANG_TIDY_VERSION_} found. Minimum 14 required!")
#    function(eztest_sa_add_source_file_ EZTEST_SA_SOURCE_FILE_ EZTEST_SA_LANG_)
#    endfunction()
#    return()
#  endif()
...
set(
  EZTEST_SA_FIXUP_COMPILE_COMMANDS_TARGET_
