...
#if (EZTEST_HAS_CLANG_VER_(19, 0, 0))
# define EZTEST_DISABLE_WC2Y_EXTENSIONS_                                       \
     EZTEST_DISABLE_WARNING_("-Wc2y-extensions")
# define EZTEST_REENABLE_WC2Y_EXTENSIONS_ EZTEST_REENABLE_WARNING_
#else
# define EZTEST_DISABLE_WC2Y_EXTENSIONS_
# define EZTEST_REENABLE_WC2Y_EXTENSIONS_
#endif
